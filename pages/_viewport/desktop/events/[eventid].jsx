...
import { AppstoreOutlined, EnvironmentOutlined, CheckCircleFilled, LikeOutlined, 
    ScheduleOutlined, FlagOutlined, CalendarOutlined, ClockCircleOutlined } from "@ant-design/icons";
                                        ...
                                        <Grid container columnSpacing={4}>
                                            ...
                                            <Grid item xs={12} md={5}>
                                                ...
                                                <Box sx={{width: '100%', paddingTop: 1}}>
                                                    <Button startIcon={<LikeOutlined />} fullWidth variant="contained" size='small'>Join Funbase</Button>
                                                </Box>
                                            </Grid>
                                        </Grid>
                                    </Grid>
