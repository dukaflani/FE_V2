...
// Icons
import { ClockCircleOutlined, EnvironmentOutlined, FireOutlined, FlagOutlined } from '@ant-design/icons';
        ...
        <Paper square >
              <Box sx={{padding: 2, display: 'flex', alignItems: 'center', justifyContent: 'start'}}>
                <Stack>
                  ...
                  <Typography component='body2' variant='body2'>Top Music Events Happening in Kenya</Typography>
                </Stack>
              </Box>
